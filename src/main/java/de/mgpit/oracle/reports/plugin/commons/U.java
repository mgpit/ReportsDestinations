...
public final class U {
    ...
    /**
     * Gets the SHA256 hash of the string given.
     * 
     * @param str String to hash
     * @return SHA256 hash of the String given, hex encoded. In case of an exception during hashing {@code null} will be returned.
     */
