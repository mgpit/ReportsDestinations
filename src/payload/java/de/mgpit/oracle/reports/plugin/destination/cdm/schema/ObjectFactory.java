    ...
    extends com.sun.xml.bind.DefaultJAXBContextImpl
{
    ...
    static {
        ...
        defaultImplementations.put((de.mgpit.oracle.reports.plugin.destination.cdm.schema.Property.class), (de.mgpit.oracle.reports.plugin.destination.cdm.schema.impl.PropertyImpl.class));
        defaultImplementations.put((de.mgpit.oracle.reports.plugin.destination.cdm.schema.Content.class), (de.mgpit.oracle.reports.plugin.destination.cdm.schema.impl.ContentImpl.class));
    }
    ...
    public de.mgpit.oracle.reports.plugin.destination.cdm.schema.Property createProperty()
        throws javax.xml.bind.JAXBException
    {
        return ((de.mgpit.oracle.reports.plugin.destination.cdm.schema.Property) newInstance((de.mgpit.oracle.reports.plugin.destination.cdm.schema.Property.class)));
    }
    ...
    public de.mgpit.oracle.reports.plugin.destination.cdm.schema.Content createContent()
        throws javax.xml.bind.JAXBException
    {
        return ((de.mgpit.oracle.reports.plugin.destination.cdm.schema.Content) newInstance((de.mgpit.oracle.reports.plugin.destination.cdm.schema.Content.class)));
    }
        ...
        extends com.sun.xml.bind.GrammarInfo
    {
        ...
        public java.lang.Class getRootElement(java.lang.String uri, java.lang.String local) {
            if (("" == uri)&&("content" == local)) {
                return (de.mgpit.oracle.reports.plugin.destination.cdm.schema.impl.ContentImpl.class);
            }
            if (("" == uri)&&("cdmdoc" == local)) {
                return (de.mgpit.oracle.reports.plugin.destination.cdm.schema.impl.CdmdocImpl.class);
            }
            if (("" == uri)&&("property" == local)) {
                return (de.mgpit.oracle.reports.plugin.destination.cdm.schema.impl.PropertyImpl.class);
            }
            return null;
        }

        public java.lang.String[] getProbePoints() {
            return new java.lang.String[] {"", "content", "", "cdmdoc", "", "property"};
        }
